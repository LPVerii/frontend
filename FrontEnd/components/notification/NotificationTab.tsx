...
export default function NotificationTab({ sharedData, dataTab = Array(), filter }: { sharedData: any, dataTab: any, filter?: any }) {
    ...
    return <>
        <div className="grid grid-cols-[40vw_1fr] mt-12 mb-[42px] h-[30px] sm:h-[40px]">
            <div className="pl-1 pt-0 mt-0 text-[12px] Lato sm:text-[1.10vw] h-[30px] sm:h-[40px]">Critical AI Notifications
                <select value={theSeverity} onChange={e => { setTheSeverity(e.target.value); }} className="w-[120px] sm:w-[14vw] sm:ml-6 bg-transparent rounded-3xl text-[#2FA4E7] pl-4 pr-6 border-[3px] border-[#2FA4E7] h-[30px] sm:h-[40px]">
            ...
            <input
                id="icon_mag"
                className="ml-auto w-[150px] sm:w-[200px] xl:w-[300px] rounded-3xl pl-5 outline-none bg-[#F0F3F9] h-[30px] sm:h-[40px]"
                type="search"
                name=""
                value={searchTerm}
